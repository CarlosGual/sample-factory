...
class SefarLearner(Learner):
    ...
    def _calculate_losses(
        ...
        return action_distribution1, policy_loss1, exploration_loss1, kl_old1, kl_loss1, value_loss1, log_prob_actions1, \
            action_distribution2, policy_loss2, exploration_loss2, kl_old2, kl_loss2, value_loss2, log_prob_actions2, locals()
        ...
        for epoch in range(self.cfg.num_epochs):
            ...
            for batch_num in range(len(minibatches)):
                ...
                with timing.add_time("losses_postprocess"):
                    ...
                    logits_l1 = log_prob_actions1/self.cfg.temp
                    logits_l2 = log_prob_actions2.detach()/self.cfg.temp
