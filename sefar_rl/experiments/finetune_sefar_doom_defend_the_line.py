...
_params = ParamGrid(
    [
        # ("seed", [0, 1111, 2222, 3333, 4444, 5555, 6666, 7777]),
        (
            "env",
            [
...
_experiments = [
    Experiment(
        "finetune_sefar_doom_defend_the_line",
...
RUN_DESCRIPTION = RunDescription("finetune_sefar_doom_defend_the_line", experiments=_experiments)
