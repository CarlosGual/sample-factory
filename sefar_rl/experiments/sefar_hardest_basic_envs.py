...
_experiments = [
    Experiment(
        ...
        "--forward_head=2 --sparsity=0.57 --temp=6 --update_mask=False --weight_kd=7 "
        "--wandb_project=sefar-rl --wandb_tags doom appo sefar",
        _params.generate_params(randomize=False),
    ),
]

RUN_DESCRIPTION = RunDescription("sefar_hardest_basic_envs", experiments=_experiments)
